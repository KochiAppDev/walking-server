...
var locationAction = function(response, client, done, user_id, lat, lon) {
    ...
    client.query(
        "UPDATE user_location SET latitude=$1, longitude=$2, update_time=now() WHERE user_id=$3; INSERT INTO user_location (latitude, longitude, user_id, update_time) SELECT $1, $2, $3, now() WHERE NOT EXISTS (SELECT 1 FROM table WHERE user_id=$3);",
